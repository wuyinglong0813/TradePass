...
class ContractSigningFlowTest {
    ...
    private final TradeContract contract = new TradeContract();
    private final FadadaContractSignTask task = new FadadaContractSignTask();
    ...
    @BeforeEach void setUp() {
        ...
        service = new FadadaContractSigningService(tasks, contracts, mock(CompanyMapper.class),
                mock(AccessControlService.class), mock(FadadaCompanyService.class), gateway,
    ...
    void callbackThatWaitedForRecoveryLockRechecksItsRetiredTaskInsteadOfOriginal() {
        contract.setStatus("ACTIVE");
        FadadaContractSignTask stale = new FadadaContractSignTask();
