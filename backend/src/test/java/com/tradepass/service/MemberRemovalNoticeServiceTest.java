...
class MemberRemovalNoticeServiceTest {
    ...
    @BeforeEach
    void setup() {
        MybatisTestSupport.initialize(MemberRemovalNotice.class);
        mapper = mock(MemberRemovalNoticeMapper.class);
        companyMapper = mock(CompanyMapper.class);
        service = new MemberRemovalNoticeService(mapper, companyMapper);
    ...
    void recordsRecipientAndCompanyNameAndReturnsUnreadNoticesWithoutCompanyMembership() {
        ...
        ArgumentCaptor<MemberRemovalNotice> notice = ArgumentCaptor.forClass(MemberRemovalNotice.class);
    ...
    void acknowledgementsAreScopedToCurrentUserAndOnlyRequestedNotices() {
        ...
        var update = (LambdaUpdateWrapper<MemberRemovalNotice>) captured.getValue();
